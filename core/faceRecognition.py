...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('C:\\Users\\asimr\\Downloads\\face\Face_Recogtion_Attendance_System\\core\\HaarCascade\\haarcascade_frontalface_default.xml')#Load haar classifier
